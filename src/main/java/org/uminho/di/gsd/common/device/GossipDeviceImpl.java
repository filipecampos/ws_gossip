...
public class TheDevice extends MembershipClientDevice implements GossipDevice {

    final static Logger logger = Logger.getLogger(TheDevice.class);
...
//            scheduledPool.scheduleWithFixedDelay(workingTask, initialWaitingPeriod, pullPeriod, TimeUnit.MILLISECONDS);
    ...
    public static void main(String[] args) throws Exception {
        if (args.length >= 2) {
            ...
            // create the device ...
            TheDevice device = new TheDevice();
